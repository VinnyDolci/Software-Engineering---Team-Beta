...
<!-- Header -->
<header class="w3-container w3-green w3-center" style="padding:200px 16px">
  <h2 class="w3-margin w3-jumbo">Input Game Code</h2>
    <form action="/JoinSession" method="post" id="code">
        <div id="example_text" class="w3-black" name></div>
        <input id="gameID" type="text" name="gameID"/><br/>
    </form>
    <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" type="submit" form="code">Join Game</button>
</header>
